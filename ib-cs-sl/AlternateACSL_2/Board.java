...
public class Board {
    ...
    public void possibleMoves(int color){
            ...
            for(int column = 0; column<8; column++){
                if(b[row][column].getColor() == 0){
                    ...
                    if(b[row+1][column+1].getColor() == 1){
                        while(row1<7 && column1<7 && b[row1+1][column1+1].getColor() == 1){
                            
                                row1 += 1;
                                column1 += 1;
                        }
                        if(row1<7 && column1<7 && b[row1+1][column1+1].getColor() == 10){
                            moves.add(row1+1);
                            moves.add(column1+1);
                        }
                    }
                    ...
                    if(b[row+1][column].getColor() == 1){
                        row1 = row;
                        column1 = column;
                        while(row1<7 && b[row1+1][column1].getColor() == 1){
                                row1 += 1;
                        }
                        if(row1<7 && b[row1+1][column1].getColor() == 10){
                            moves.add(row1+1);
                            moves.add(column1);
                        }
                    }
                    ...
                    if(b[row+1][column-1].getColor() == 1){
                        row1 = row;
                        column1 = column;
                        while(row1<7 && column1 >0 && b[row1+1][column1-1].getColor() == 1){
                                row1 += 1;
                                column1 -= 1;
                        }
                        if(row1<7 && column1 >0 && b[row1+1][column1-1].getColor() == 10){
                            moves.add(row1+1);
                            moves.add(column1-1);
                        }
                    }
                    ...
                    if(b[row][column+1].getColor() == 1){
                        row1 = row;
                        column1 = column;
                        while(column1 <7 && b[row1][column1+1].getColor() == 1){
                                column1 += 1;
                        }
                        if(column1 <7 && b[row1][column1+1].getColor() == 10){
                            moves.add(row1);
                            moves.add(column1+1);
                        }
                    }
                    ...
                    if(b[row][column-1].getColor() == 1){
                        row1 = row;
                        column1 = column;
                        while(column1 >0 && b[row1][column1-1].getColor() == 1){
                                column1 -= 1;
                        }
                        if(column1 >0 && b[row1][column1-1].getColor() == 10){
                            moves.add(row1);
                            moves.add(column1-1);
                        }
                    }
                    ...
                    if(b[row-1][column+1].getColor() == 1){
                        row1 = row;
                        column1 = column;
                        while(row1>0 && column1 <7 && b[row1-1][column1+1].getColor() == 1){
                                row1 -= 1;
                                column1 += 1;
                        }
                        if(row1>0 && column1 <7 && b[row1-1][column1+1].getColor() == 10){
                            moves.add(row1-1);
                            moves.add(column1+1);
                        }
                    }
                    ...
                    if(b[row-1][column].getColor() == 1){
                        row1 = row;
                        column1 = column;
                        while(row1>0 && b[row1-1][column1].getColor() == 1){
                               row1 -= 1; 
                        }
                        if(row1>0 && b[row1-1][column1].getColor() == 10){
                            moves.add(row1-1);
                            moves.add(column1);
                        }
                    }
                    ...
                    if(b[row-1][column-1].getColor() == 1){
                        row1 = row;
                        column1 = column;
                        while(row1>0 && column1 >0 && b[row1-1][column1-1].getColor() == 1){
                                row1-=1;
                                column1-=1;
                        }
                        if(row1>0 && column1 >0 && b[row1-1][column1-1].getColor() == 10){
                            moves.add(row1-1);
                            moves.add(column1-1);
                        }
                    }
            ...
            for(int column = 0; column<8; column++){
                if(b[row][column].getColor() == 1){
                    ...
                    if(b[row+1][column+1].getColor() == 0){
                        while(row1<7 && column1 <7 && b[row1+1][column1+1].getColor() == 0){
                                row1 += 1;
                                column1 += 1;
                        }
                        if(row1<7 && column1 <7 && b[row1+1][column1+1].getColor() == 10){
                    ...
                    if(b[row+1][column].getColor() == 0){
                        row1 = row;
                        column1 = column;
                        while(row1<7 && b[row1+1][column1].getColor() == 0){
                                row1 += 1;
                        }
                        if(row1<7 && b[row1+1][column1].getColor() == 10){
                            moves.add(row1+1);
                    ...
                    if(b[row+1][column-1].getColor() == 0){
                        row1 = row;
                        column1 = column;
                        while(row1<7 && column1 >0 && b[row1+1][column1-1].getColor() == 0){
                                row1 += 1;
                                column1 -= 1;
                        }
                        if(row1<7 && column1 >0 && b[row1+1][column1-1].getColor() == 10){
                    ...
                    if(b[row][column+1].getColor() == 0){
                        row1 = row;
                        column1 = column;
                        while(column1 <7 && b[row1][column1+1].getColor() == 0){
                                column1 += 1;
                        }
                        if(column1 <7 && b[row1][column1+1].getColor() == 10){
                            moves.add(row1);
                    ...
                    if(b[row][column-1].getColor() == 0){
                        row1 = row;
                        column1 = column;
                        while(column1 >0 && b[row1][column1-1].getColor() == 0){
                                column1 -= 1;
                        }
                        if(column1 >0 && b[row1][column1-1].getColor() == 10){
                            moves.add(row1);
                    ...
                    if(b[row-1][column+1].getColor() == 0){
                        row1 = row;
                        column1 = column;
                        while(row1>0 && column1 <7 && b[row1-1][column1+1].getColor() == 0){
                                row1 -= 1;
                                column1 += 1;
                        }
                        if(row1>0 && column1 <7 && b[row1-1][column1+1].getColor() == 10){
                    ...
                    if(b[row-1][column].getColor() == 0){
                        row1 = row;
                        column1 = column;
                        while(row1>0 && b[row1-1][column1].getColor() == 0){
                               row1 -= 1; 
                        }
                        if(row1>0 && b[row1-1][column1].getColor() == 10){
                            moves.add(row1-1);
                    ...
                    if(b[row-1][column-1].getColor() == 0){
                        row1 = row;
                        column1 = column;
                        while(row1>0 && column1 >0 && b[row1-1][column1-1].getColor() == 0){
                                row1-=1;
                                column1-=1;
                        }
                        if(row1>0 && column1 >0 && b[row1-1][column1-1].getColor() == 10){
        ...
        for(int i = 0; i<moves.size(); i++){
            System.out.print((moves.get(i)+1) + "," + (moves.get(i+1)+1) + "  ");
            i+=1;
